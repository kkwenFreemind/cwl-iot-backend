...
/**
 * Unified service interface for managing menu data and operations with support
 * for multiple persistence strategies.
 * <p>
 * Provides methods for listing, retrieving, saving, updating, and deleting menu
 * records,
 * as well as generating menu options and retrieving user routes. Used in menu
 * management and navigation features.
 * </p>
 *
 * @author Chang Xiu-Wen, AI-Enhanced
 * @since 2025/09/11
 */
public interface SystemMenuJpaService {
