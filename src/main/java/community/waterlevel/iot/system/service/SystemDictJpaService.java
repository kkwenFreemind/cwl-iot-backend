...
/**
 * Unified service interface for managing dictionary data with support for both MyBatis and JPA.
 * <p>
 * Provides methods for paginated queries, listing, retrieving, saving, updating, and deleting dictionary records,
 * as well as obtaining dictionary codes by IDs. Used in dictionary management features to support CRUD and option selection.
 * </p>
 *
 * @author Chang Xiu-Wen, AI-Enhanced
 * @since 2025/09/11
 */
public interface SystemDictJpaService {
